...
const SignUpForm = () => {
  /** Initialize the field variables with computer properties. */
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      history.push("/signin"); // where to go next after the registration
    } catch (err) {
      console.log("error in /dj-rest-auth/registration/", err);
